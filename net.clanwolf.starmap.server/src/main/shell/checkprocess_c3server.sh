...
#ps -fC java | grep C3-Server- || /opt/jdk-20/bin/java -jar /var/www/vhosts/clanwolf.net/httpdocs/apps/C3/server/C3-Server-7.3.19.jar ; exit
#exit
if [ -f /var/www/vhosts/clanwolf.net/httpdocs/apps/C3/server/C3-Server_shutdown.flag ]
then
    exit 0
else
    ps -fC java | grep C3-Server- || /opt/jdk-20/bin/java -jar /var/www/vhosts/clanwolf.net/httpdocs/apps/C3/server/C3-Server-7.3.19.jar
    exit 0
fi
