...
public class MechIdInfo {
    ...
    public MechIdInfo() {
        ...
        //4 neue Mech's sind dazu gekommen
        this.mechids.put(850,new MechIdInfo(EFaction.CLAN,"BLOODASP",90,EMechclass.ASSAULT, EVariantType.STANDARD,"BLOOD ASP BAS-E","BAS-E"));
        this.mechids.put(851,new MechIdInfo(EFaction.CLAN,"BLOODASP",90,EMechclass.ASSAULT, EVariantType.SPECIAL,"BLOOD ASP BAS-E(S)","BAS-E(S)"));
        this.mechids.put(852,new MechIdInfo(EFaction.CLAN,"SHADOWCAT",45,EMechclass.MEDIUM, EVariantType.STANDARD,"SHADOW CAT SHC-D","SHC-D"));
        this.mechids.put(853,new MechIdInfo(EFaction.CLAN,"SHADOWCAT",45,EMechclass.MEDIUM, EVariantType.SPECIAL,"SHADOW CAT SHC-D(S)","SHC-D(S)"));
