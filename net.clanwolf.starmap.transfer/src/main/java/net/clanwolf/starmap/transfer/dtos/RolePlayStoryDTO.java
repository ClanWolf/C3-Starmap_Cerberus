...
@JsonIdentityInfo(
		scope= RolePlayStoryDTO.class,
		generator=ObjectIdGenerators.PropertyGenerator.class,
		property = "id")
public class RolePlayStoryDTO extends Dto {
    ...
    private RolePlayStoryDTO parentStory;
	...
	public void setNewCharIDs(ArrayList<Long> characterIDs) {
		this.newCharIDs = characterIDs;
	}
