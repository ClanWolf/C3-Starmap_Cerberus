...
public class MechIdInfo {
    ...
    public MechIdInfo() {
        ...
        this.mechids.put(8,new MechIdInfo(EFaction.INNERSPHERE,"CENTURION",50, EMechclass.MEDIUM,"LOYALTY","CENTURION CN9-AH(L)","CN9-AH(L)"));
        ...
        this.mechids.put(105,new MechIdInfo(EFaction.INNERSPHERE,"LOCUST",20, EMechclass.LIGHT,"PHOENIX","LOCUST LCT-1V(P)","LCT-1V(P)"));
        ...
        this.mechids.put(109,new MechIdInfo(EFaction.INNERSPHERE,"SHADOWHAWK",55, EMechclass.MEDIUM,"PHOENIX","SHADOW HAWK SHD-2H(P)","SHD-2H(P)"));
        ...
        this.mechids.put(113,new MechIdInfo(EFaction.INNERSPHERE,"THUNDERBOLT",65, EMechclass.HEAVY,"PHOENIX","THUNDERBOLT TDR-5S(P)","TDR-5S(P)"));
        ...
        this.mechids.put(117,new MechIdInfo(EFaction.INNERSPHERE,"BATTLEMASTER",85, EMechclass.ASSAULT,"PHOENIX","BATTLEMASTER BLR-1G(P)","BLR-1G(P)"));
        ...
        this.mechids.put(129,new MechIdInfo(EFaction.INNERSPHERE,"WOLVERINE",55, EMechclass.MEDIUM,"PHOENIX","WOLVERINE WVR-6R(P)","WVR-6R(P)"));
        ...
        this.mechids.put(162,new MechIdInfo(EFaction.CLAN,"TIMBERWOLF",75, EMechclass.HEAVY,"INVASION","TIMBER WOLF TBR-PRIME(I)","TBR-PRIME(I)"));
        ...
        this.mechids.put(166,new MechIdInfo(EFaction.CLAN,"ADDER",35, EMechclass.LIGHT,"INVASION","ADDER ADR-PRIME(I)","ADR-PRIME(I)"));
        ...
        this.mechids.put(170,new MechIdInfo(EFaction.CLAN,"DIREWOLF",100, EMechclass.ASSAULT,"INVASION","DIRE WOLF DWF-PRIME(I)","DWF-PRIME(I)"));
        ...
        this.mechids.put(174,new MechIdInfo(EFaction.CLAN,"KITFOX",30, EMechclass.LIGHT,"INVASION","KIT FOX KFX-PRIME(I)","KFX-PRIME(I)"));
        ...
        this.mechids.put(178,new MechIdInfo(EFaction.CLAN,"NOVA",50, EMechclass.MEDIUM,"INVASION","NOVA NVA-PRIME(I)","NVA-PRIME(I)"));
        ...
        this.mechids.put(182,new MechIdInfo(EFaction.CLAN,"STORMCROW",55, EMechclass.MEDIUM,"INVASION","STORMCROW SCR-PRIME(I)","SCR-PRIME(I)"));
        ...
        this.mechids.put(186,new MechIdInfo(EFaction.CLAN,"SUMMONER",70, EMechclass.HEAVY,"INVASION","SUMMONER SMN-PRIME(I)","SMN-PRIME(I)"));
        ...
        this.mechids.put(190,new MechIdInfo(EFaction.CLAN,"WARHAWK",85, EMechclass.ASSAULT,"INVASION","WARHAWK WHK-PRIME(I)","WHK-PRIME(I)"));
        ...
        this.mechids.put(194,new MechIdInfo(EFaction.CLAN,"TIMBERWOLF",75, EMechclass.HEAVY,"GOLD","TIMBER WOLF TBR-PRIME(G)","TBR-PRIME(G)"));
        this.mechids.put(195,new MechIdInfo(EFaction.CLAN,"ADDER",35, EMechclass.LIGHT,"GOLD","ADDER ADR-PRIME(G)","ADR-PRIME(G)"));
        this.mechids.put(196,new MechIdInfo(EFaction.CLAN,"DIREWOLF",100, EMechclass.ASSAULT,"GOLD","DIRE WOLF DWF-PRIME(G)","DWF-PRIME(G)"));
        this.mechids.put(197,new MechIdInfo(EFaction.CLAN,"KITFOX",30, EMechclass.LIGHT,"GOLD","KIT FOX KFX-PRIME(G)","KFX-PRIME(G)"));
        this.mechids.put(198,new MechIdInfo(EFaction.CLAN,"NOVA",50, EMechclass.MEDIUM,"GOLD","NOVA NVA-PRIME(G)","NVA-PRIME(G)"));
        this.mechids.put(199,new MechIdInfo(EFaction.CLAN,"STORMCROW",55, EMechclass.MEDIUM,"GOLD","STORMCROW SCR-PRIME(G)","SCR-PRIME(G)"));
        this.mechids.put(200,new MechIdInfo(EFaction.CLAN,"SUMMONER",70, EMechclass.HEAVY,"GOLD","SUMMONER SMN-PRIME(G)","SMN-PRIME(G)"));
        this.mechids.put(201,new MechIdInfo(EFaction.CLAN,"WARHAWK",85, EMechclass.ASSAULT,"GOLD","WARHAWK WHK-PRIME(G)","WHK-PRIME(G)"));
        ...
        this.mechids.put(211,new MechIdInfo(EFaction.CLAN,"MADDOG",60, EMechclass.HEAVY,"INVASION","MAD DOG MDD-PRIME(I)","MDD-PRIME(I)"));
        ...
        this.mechids.put(216,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100, EMechclass.ASSAULT,"LOYALTY","ATLAS AS7-S(L)","AS7-S(L)"));
        ...
        this.mechids.put(218,new MechIdInfo(EFaction.CLAN,"ICEFERRET",45, EMechclass.MEDIUM,"INVASION","ICE FERRET IFR-PRIME(I)","IFR-PRIME(I)"));
        ...
        this.mechids.put(224,new MechIdInfo(EFaction.CLAN,"MISTLYNX",25, EMechclass.LIGHT,"INVASION","MIST LYNX MLX-PRIME(I)","MLX-PRIME(I)"));
        ...
        this.mechids.put(229,new MechIdInfo(EFaction.CLAN,"HELLBRINGER",65, EMechclass.HEAVY,"INVASION","HELLBRINGER HBR-PRIME(I)","HBR-PRIME(I)"));
        ...
        this.mechids.put(233,new MechIdInfo(EFaction.CLAN,"GARGOYLE",80, EMechclass.ASSAULT,"INVASION","GARGOYLE GAR-PRIME(I)","GAR-PRIME(I)"));
        ...
        this.mechids.put(237,new MechIdInfo(EFaction.INNERSPHERE,"KINGCRAB",100, EMechclass.ASSAULT,"LOYALTY","KING CRAB KGC-000(L)","KGC-000(L)"));
        ...
        this.mechids.put(243,new MechIdInfo(EFaction.INNERSPHERE,"PANTHER",35, EMechclass.LIGHT,"RESISTANCE","PANTHER PNT-10K(R)","PNT-10K(R)"));
        ...
        this.mechids.put(247,new MechIdInfo(EFaction.INNERSPHERE,"ENFORCER",50, EMechclass.MEDIUM,"RESISTANCE","ENFORCER ENF-5D(R)","ENF-5D(R)"));
        ...
        this.mechids.put(252,new MechIdInfo(EFaction.INNERSPHERE,"GRASSHOPPER",70, EMechclass.HEAVY,"RESISTANCE","GRASSHOPPER GHR-5J(R)","GHR-5J(R)"));
        ...
        this.mechids.put(256,new MechIdInfo(EFaction.INNERSPHERE,"ZEUS",80, EMechclass.ASSAULT,"RESISTANCE","ZEUS ZEU-6S(R)","ZEU-6S(R)"));
        ...
        this.mechids.put(274,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30, EMechclass.LIGHT,"WHO YOU COLLING SLOW?","URBANMECH UM-R63(S)","UM-R63(S)"));
        ...
        this.mechids.put(279,new MechIdInfo(EFaction.CLAN,"EBONJAGUAR",65, EMechclass.HEAVY,"INVASION","EBON JAGUAR EBJ-PRIME(I)","EBJ-PRIME(I)"));
        ...
        this.mechids.put(284,new MechIdInfo(EFaction.CLAN,"EXECUTIONER",95, EMechclass.ASSAULT,"INVASION","EXECUTIONER EXE-PRIME(I)","EXE-PRIME(I)"));
        ...
        this.mechids.put(290,new MechIdInfo(EFaction.CLAN,"ARCTICCHEETAH",30, EMechclass.LIGHT,"INVASION","ARCTIC CHEETAH ACH-PRIME(I)","ACH-PRIME(I)"));
        ...
        this.mechids.put(295,new MechIdInfo(EFaction.CLAN,"SHADOWCAT",45, EMechclass.MEDIUM,"INVASION","SHADOW CAT SHC-PRIME(I)","SHC-PRIME(I)"));
        ...
        this.mechids.put(319,new MechIdInfo(EFaction.INNERSPHERE,"BLACKKNIGHT",75, EMechclass.HEAVY,"RESISTANCE II","BLACK KNIGHT BL-6-KNT(R)","BL-6-KNT(R)"));
        ...
        this.mechids.put(324,new MechIdInfo(EFaction.INNERSPHERE,"MAULER",90, EMechclass.ASSAULT,"RESISTANCE II","MAULER MAL-1R(R)","MAL-1R(R)"));
        ...
        this.mechids.put(329,new MechIdInfo(EFaction.INNERSPHERE,"CRAB",50, EMechclass.MEDIUM,"RESISTANCE II","CRAB CRB-27(R)","CRB-27(R)"));
        ...
        this.mechids.put(334,new MechIdInfo(EFaction.INNERSPHERE,"WOLFHOUND",35, EMechclass.LIGHT,"RESISTANCE II","WOLFHOUND WLF-2(R)","WLF-2(R)"));
        ...
        this.mechids.put(339,new MechIdInfo(EFaction.INNERSPHERE,"CICADA",40, EMechclass.MEDIUM,"LOYALTY","CICADA CDA-3F(L)","CDA-3F(L)"));
        this.mechids.put(340,new MechIdInfo(EFaction.INNERSPHERE,"WOLVERINE",55, EMechclass.MEDIUM,"LOYALTY","WOLVERINE WVR-7D(L)","WVR-7D(L)"));
        this.mechids.put(341,new MechIdInfo(EFaction.INNERSPHERE,"ZEUS",80, EMechclass.ASSAULT,"LOYALTY","ZEUS ZEU-9S2(L)","ZEU-9S2(L)"));
        this.mechids.put(342,new MechIdInfo(EFaction.CLAN,"NOVA",50, EMechclass.MEDIUM,"LOYALTY","NOVA NVA-D(L)","NVA-D(L)"));
        this.mechids.put(343,new MechIdInfo(EFaction.CLAN,"EXECUTIONER",95, EMechclass.ASSAULT,"LOYALTY","EXECUTIONER EXE-C(L)","EXE-C(L)"));
        this.mechids.put(344,new MechIdInfo(EFaction.INNERSPHERE,"MARAUDER",75, EMechclass.HEAVY,"RETURN OF AN ICON","MARAUDER MAD-3R(S)","MAD-3R(S)"));
        ...
        this.mechids.put(361,new MechIdInfo(EFaction.CLAN,"JENNERIIC",35, EMechclass.LIGHT,"ORIGINS IIC","JENNER IIC JR7-IIC(O)","JR7-IIC(O)"));
        ...
        this.mechids.put(366,new MechIdInfo(EFaction.CLAN,"HUNCHBACKIIC",50, EMechclass.MEDIUM,"ORIGINS IIC","HUNCHBACK IIC HBK-IIC(O)","HBK-IIC(O)"));
        ...
        this.mechids.put(371,new MechIdInfo(EFaction.CLAN,"ORIONIIC",75, EMechclass.HEAVY,"ORIGINS IIC","ORION IIC ON1-IIC(O)","ON1-IIC(O)"));
        ...
        this.mechids.put(376,new MechIdInfo(EFaction.CLAN,"HIGHLANDERIIC",90, EMechclass.ASSAULT,"ORIGINS IIC","HIGHLANDER IIC HGN-IIC(O)","HGN-IIC(O)"));
        ...
        this.mechids.put(381,new MechIdInfo(EFaction.INNERSPHERE,"WARHAMMER",70, EMechclass.HEAVY,"RETURN OF AN ICON","WARHAMMER WHM-6R(S)","WHM-6R(S)"));
        ...
        this.mechids.put(386,new MechIdInfo(EFaction.INNERSPHERE,"RIFLEMAN",60, EMechclass.HEAVY,"RETURN OF AN ICON","RIFLEMAN RFL-3N(S)","RFL-3N(S)"));
        ...
        this.mechids.put(391,new MechIdInfo(EFaction.INNERSPHERE,"ARCHER",70, EMechclass.HEAVY,"RETURN OF AN ICON","ARCHER ARC-2R(S)","ARC-2R(S)"));
        ...
        this.mechids.put(405,new MechIdInfo(EFaction.CLAN,"KODIAK",100, EMechclass.ASSAULT,"TOTEM 'MECH","KODIAK KDK-1(S)","KDK-1(S)"));
        ...
        this.mechids.put(412,new MechIdInfo(EFaction.INNERSPHERE,"PHOENIXHAWK",45, EMechclass.MEDIUM,"RETURN OF AN ICON","PHOENIX HAWK PXH-1(S)","PXH-1(S)"));
        ...
        this.mechids.put(421,new MechIdInfo(EFaction.CLAN,"VIPER",40, EMechclass.MEDIUM,"STRIKE FEAR","VIPER VPR-PRIME(S)","VPR-PRIME(S)"));
        ...
        this.mechids.put(433,new MechIdInfo(EFaction.INNERSPHERE,"CYCLOPS",90, EMechclass.ASSAULT,"TAKE COMMAND","CYCLOPS CP-11-A(S)","CP-11-A(S)"));
        ...
        this.mechids.put(441,new MechIdInfo(EFaction.CLAN,"NIGHTGYR",75, EMechclass.HEAVY,"PACKS A PUNCH","NIGHT GYR NTG-PRIME(S)","NTG-PRIME(S)"));
        ...
        this.mechids.put(456,new MechIdInfo(EFaction.CLAN,"HUNTSMAN",50, EMechclass.MEDIUM,"IT'S HUNTING SEASON","HUNTSMAN HMN-PRIME(S)","HMN-PRIME(S)"));
        ...
        this.mechids.put(463,new MechIdInfo(EFaction.INNERSPHERE,"BLACKJACK",45, EMechclass.MEDIUM,"LOYALTY","BLACKJACK BJ-2(L)","BJ-2(L)"));
        this.mechids.put(464,new MechIdInfo(EFaction.INNERSPHERE,"CATAPHRACT",70, EMechclass.HEAVY,"LOYALTY","CATAPHRACT CTF-3L(L)","CTF-3L(L)"));
        this.mechids.put(465,new MechIdInfo(EFaction.INNERSPHERE,"STALKER",85, EMechclass.ASSAULT,"LOYALTY","STALKER STK-3FB(L)","STK-3FB(L)"));
        this.mechids.put(466,new MechIdInfo(EFaction.CLAN,"HELLBRINGER",65, EMechclass.HEAVY,"LOYALTY","HELLBRINGER HBR-F(L)","HBR-F(L)"));
        this.mechids.put(467,new MechIdInfo(EFaction.CLAN,"SUMMONER",70, EMechclass.HEAVY,"LOYALTY","SUMMONER SMN-F(L)","SMN-F(L)"));
        this.mechids.put(468,new MechIdInfo(EFaction.CLAN,"SUMMONER",70, EMechclass.HEAVY,"LOYALTY","SUMMONER SMN-M(L)","SMN-M(L)"));
        this.mechids.put(469,new MechIdInfo(EFaction.CLAN,"LINEBACKER",65, EMechclass.HEAVY,"LEAD THE CHARGE","LINEBACKER LBK-PRIME(S)","LBK-PRIME(S)"));
        ...
        this.mechids.put(492,new MechIdInfo(EFaction.CLAN,"MARAUDERIIC",85, EMechclass.ASSAULT,"EVOLUTION OF AN ICON","MARAUDER IIC MAD-IIC(S)","MAD-IIC(S)"));
        ...
        this.mechids.put(500,new MechIdInfo(EFaction.INNERSPHERE,"BUSHWACKER",55, EMechclass.MEDIUM,"BLAZE A TRAIL","BUSHWACKER BSW-X1(S)","BSW-X1(S)"));
        ...
        this.mechids.put(507,new MechIdInfo(EFaction.CLAN,"SUPERNOVA",90, EMechclass.ASSAULT,"DESTROYER OF WORLS","SUPERNOVA SNV-1(S)","SNV-1(S)"));
        ...
        this.mechids.put(519,new MechIdInfo(EFaction.INNERSPHERE,"ASSASSIN",40, EMechclass.MEDIUM,"THE PROFESSIONAL","ASSASSIN ASN-21(S)","ASN-21(S)"));
        ...
        this.mechids.put(534,new MechIdInfo(EFaction.INNERSPHERE,"ROUGHNECK",65, EMechclass.HEAVY,"ALL WORK AN TONS OF PLAY","ROUGHNECK RGH-1A(S)","RGH-1A(S)"));
        ...
        this.mechids.put(541,new MechIdInfo(EFaction.INNERSPHERE,"JAVELIN",30, EMechclass.LIGHT,"TIP OF THE SPEAR","JAVELIN JVN-10N(S)","JVN-10N(S)"));
        ...
        this.mechids.put(558,new MechIdInfo(EFaction.INNERSPHERE,"UZIEL",50, EMechclass.MEDIUM,"CIVIL WAR","UZIEL UZL-3S(S)","UZL-3S(S)"));
        ...
        this.mechids.put(565,new MechIdInfo(EFaction.INNERSPHERE,"ANNIHILATOR",100, EMechclass.ASSAULT,"CIVIL WAR","ANNIHILATOR ANH-2A(S)","ANH-2A(S)"));
        ...
        this.mechids.put(572,new MechIdInfo(EFaction.CLAN,"COUGAR",35, EMechclass.LIGHT,"CIVIL WAR","COUGAR COU-PRIME(S)","COU-PRIME(S)"));
        ...
        this.mechids.put(579,new MechIdInfo(EFaction.CLAN,"MADCATMKII",90, EMechclass.ASSAULT,"CIVIL WAR","MAD CAT MK II MCII-1(S)","MCII-1(S)"));
        ...
        this.mechids.put(608,new MechIdInfo(EFaction.INNERSPHERE,"OSIRIS",30, EMechclass.LIGHT,"CIVIL WAR ESCALATION","OSIRIS OSR-3D(S)","OSR-3D(S)"));
        ...
        this.mechids.put(615,new MechIdInfo(EFaction.INNERSPHERE,"NIGHTSTAR",95, EMechclass.ASSAULT,"CIVIL WAR ESCALATION","NIGHTSTAR NSR-9J(S)","NSR-9J(S)"));
        ...
        this.mechids.put(622,new MechIdInfo(EFaction.CLAN,"ARCTICWOLF",40, EMechclass.MEDIUM,"CIVIL WAR ESCALATION","ARCTIC WOLF ACW-PRIME(S)","ACW-PRIME(S)"));
        ...
        this.mechids.put(629,new MechIdInfo(EFaction.CLAN,"NOVACAT",70, EMechclass.HEAVY,"CIVIL WAR ESCALATION","NOVA CAT NCT-PRIME(S)","NCT-PRIME(S)"));
        ...
        this.mechids.put(636,new MechIdInfo(EFaction.INNERSPHERE,"THANATOS",75, EMechclass.HEAVY,"DEATH'S CALLING CARD","THANATOS TNS-4S(S)","TNS-4S(S)"));
        ...
        this.mechids.put(643,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30, EMechclass.LIGHT,"LOYALTY","URBANMECH UM-R68(L)","UM-R68(L)"));
        this.mechids.put(644,new MechIdInfo(EFaction.INNERSPHERE,"GRIFFIN",55, EMechclass.MEDIUM,"LOYALTY","GRIFFIN GRF-5M(L)","GRF-5M(L)"));
        this.mechids.put(645,new MechIdInfo(EFaction.INNERSPHERE,"VICTOR",80, EMechclass.ASSAULT,"LOYALTY","VICTOR VTR-9A1(L)","VTR-9A1(L)"));
        this.mechids.put(646,new MechIdInfo(EFaction.CLAN,"KITFOX",30, EMechclass.LIGHT,"LOYALTY","KIT FOX KFX-G(L)","KFX-G(L)"));
        this.mechids.put(647,new MechIdInfo(EFaction.CLAN,"LINEBACKER",65, EMechclass.HEAVY,"LOYALTY","LINEBACKER LBK-H(L)","LBK-H(L)"));
        this.mechids.put(648,new MechIdInfo(EFaction.INNERSPHERE,"HELLSPAWN",45, EMechclass.MEDIUM,"HELL HATH NO FURY","HELLSPAWN HSN-7D(S)","HSN-7D(S)"));
        ...
        this.mechids.put(655,new MechIdInfo(EFaction.CLAN,"PIRANHA",20, EMechclass.LIGHT,"PREPARE TO BE SHOOLED","PIRANHA PIR-1(S)","PIR-1(S)"));
        ...
        this.mechids.put(662,new MechIdInfo(EFaction.CLAN,"BLACKLANNER",55, EMechclass.MEDIUM,"ATTACK IN BLACK","BLACK LANNER BKL-PRIME(S)","BKL-PRIME(S)"));
        ...
        this.mechids.put(674,new MechIdInfo(EFaction.CLAN,"SUNSPIDER",70, EMechclass.HEAVY,"DESERT STRIKE","SUN SPIDER SNS-PRIME(S)","SNS-PRIME(S)"));
        ...
        this.mechids.put(683,new MechIdInfo(EFaction.INNERSPHERE,"FAFNIR",100, EMechclass.ASSAULT,"FEAR NOTHING","FAFNIR FNR-5(S)","FNR-5(S)"));
        ...
        this.mechids.put(704,new MechIdInfo(EFaction.CLAN,"BLOODASP",90, EMechclass.ASSAULT,"COLD BLOODED","BLOOD ASP BAS-PRIME(S)","BAS-PRIME(S)"));
        ...
        this.mechids.put(711,new MechIdInfo(EFaction.INNERSPHERE,"FLEA",20, EMechclass.LIGHT,"SCRATCH THAT ITCH","FLEA FLE-17(S)","FLE-17(S)"));
        ...
        this.mechids.put(718,new MechIdInfo(EFaction.CLAN,"HELLFIRE",60, EMechclass.HEAVY,"UNLEASHED","HELLFIRE HLF-1(S)","HLF-1(S)"));
        ...
        this.mechids.put(725,new MechIdInfo(EFaction.INNERSPHERE,"VULCAN",40, EMechclass.MEDIUM,"FORGED IN FIRE","VULCAN VL-2T(S)","VL-2T(S)"));
        ...
        this.mechids.put(732,new MechIdInfo(EFaction.CLAN,"INCUBUS",30, EMechclass.LIGHT,"FROM THE SHADOWS","INCUBUS INC-1(S)","INC-1(S)"));
        ...
        this.mechids.put(739,new MechIdInfo(EFaction.INNERSPHERE,"CHAMPION",60, EMechclass.HEAVY,"THE UNDISPUTED","CHAMPION CHP-1N(S)","CHP-1N(S)"));
        ...
        this.mechids.put(746,new MechIdInfo(EFaction.CLAN,"VAPOREAGLE",55, EMechclass.MEDIUM,"TURN AND BURN","VAPOR EAGLE VGL-1(S)","VGL-1(S)"));
        ...
        this.mechids.put(753,new MechIdInfo(EFaction.INNERSPHERE,"JAVELIN",30, EMechclass.LIGHT,"LOYALTY","JAVELIN JVN-11F(L)","JVN-11F(L)"));
        this.mechids.put(754,new MechIdInfo(EFaction.INNERSPHERE,"RIFLEMAN",60, EMechclass.HEAVY,"LOYALTY","RIFLEMAN RFL-8D(L)","RFL-8D(L)"));
        this.mechids.put(755,new MechIdInfo(EFaction.INNERSPHERE,"WARHAMMER",70, EMechclass.HEAVY,"LOYALTY","WARHAMMER WHM-4L(L)","WHM-4L(L)"));
        this.mechids.put(756,new MechIdInfo(EFaction.CLAN,"NIGHTGYR",75, EMechclass.HEAVY,"LOYALTY","NIGHT GYR NTG-H(L)","NTG-H(L)"));
        this.mechids.put(757,new MechIdInfo(EFaction.CLAN,"MARAUDERIIC",85, EMechclass.ASSAULT,"LOYALTY","MARAUDER IIC MAD-IIC-2(L)","MAD-IIC-2(L)"));
        this.mechids.put(758,new MechIdInfo(EFaction.INNERSPHERE,"CHARGER",80, EMechclass.ASSAULT,"EVOLUTION","CHARGER CGR-1A1(S)","CGR-1A1(S)"));
        ...
        this.mechids.put(763,new MechIdInfo(EFaction.INNERSPHERE,"HATAMOTOCHI",80, EMechclass.ASSAULT,"EVOLUTION","HATAMOTO-CHI HTM-27T(S)","HTM-27T(S)"));
        ...
        this.mechids.put(768,new MechIdInfo(EFaction.CLAN,"WARHAMMERIIC",80, EMechclass.ASSAULT,"SUPERIOR FIREPOWER","WARHAMMER IIC WHM-IIC(S)","WHM-IIC(S)"));
        ...
        this.mechids.put(782,new MechIdInfo(EFaction.INNERSPHERE,"CORSAIR",95, EMechclass.ASSAULT,"GIVE NO QUARTER","CORSAIR COR-5R(S)","COR-5R(S)"));
        ...
        this.mechids.put(790,new MechIdInfo(EFaction.INNERSPHERE,"MARAUDERII",100, EMechclass.ASSAULT,"THE ULTIMATE WEAPON","MARAUDER II MAD-4A(S)","MAD-4A(S)"));
        ...
        this.mechids.put(797,new MechIdInfo(EFaction.CLAN,"RIFLEMANIIC",65, EMechclass.HEAVY,"DEADLY ACCURATE","RIFLEMAN IIC RFL-IIC(S)","RFL-IIC(S)"));
        ...
        this.mechids.put(808,new MechIdInfo(EFaction.INNERSPHERE,"DERVISH",55, EMechclass.MEDIUM,"WARRIOR SPIRIT","DERVISH DV-6M(S)","DV-6M(S)"));
        ...
        this.mechids.put(827,new MechIdInfo(EFaction.INNERSPHERE,"THUNDERBOLT",65, EMechclass.HEAVY,"STRYKER","THUNDERBOLT TDR-10SE(S)","TDR-10SE(S)"));
        this.mechids.put(828,new MechIdInfo(EFaction.INNERSPHERE,"DRAGON",60, EMechclass.HEAVY,"STRYKER","GRAND DRAGON DRG-1G(S)","DRG-1G(S)"));
        ...
        this.mechids.put(831,new MechIdInfo(EFaction.CLAN,"TIMBERWOLF",75, EMechclass.HEAVY,"WARDEN","TIMBER WOLF TBR-BH(S)","TBR-BH(S)"));
        this.mechids.put(832,new MechIdInfo(EFaction.CLAN,"DIREWOLF",100, EMechclass.ASSAULT,"WARDEN","DIRE WOLF DWF-C(S)","DWF-C(S)"));
        ...
        this.mechids.put(836,new MechIdInfo(EFaction.INNERSPHERE,"PHOENIXHAWK",45, EMechclass.MEDIUM,"HUNTER","PHOENIX HAWK PXH-7S(S)","PXH-7S(S)"));
        this.mechids.put(837,new MechIdInfo(EFaction.INNERSPHERE,"STALKER",85, EMechclass.ASSAULT,"STANDARD","STALKER STK-7D","STK-7D"));
        this.mechids.put(838,new MechIdInfo(EFaction.INNERSPHERE,"STALKER",85, EMechclass.ASSAULT,"HUNTER","STALKER STK-7D(S)","STK-7D(S)"));
        this.mechids.put(839,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30, EMechclass.LIGHT,"STANDARD","URBANMECH UM-R80","UM-R80"));
        this.mechids.put(840,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30, EMechclass.LIGHT,"LOYALTY","URBANMECH UM-R80(L)","UM-R80(L)"));
        this.mechids.put(841,new MechIdInfo(EFaction.CLAN,"VIPER",40, EMechclass.MEDIUM,"STANDARD","VIPER VPR-F","VPR-F"));
        this.mechids.put(842,new MechIdInfo(EFaction.CLAN,"VIPER",40, EMechclass.MEDIUM,"LOYALTY","VIPER VPR-F(L)","VPR-F(L)"));
        this.mechids.put(843,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100, EMechclass.ASSAULT,"STANDARD","ATLAS AS7-K3","AS7-K3"));
        this.mechids.put(844,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100, EMechclass.ASSAULT,"LOYALTY","ATLAS AS7-K3(L)","AS7-K3(L)"));
        ...
        this.mechids.put(998,new MechIdInfo(EFaction.INNERSPHERE,"HUNCHBACK",50, EMechclass.MEDIUM,"FOUNDER","HUNCHBACK HBK-4G(F)","HBK-4G(F)"));
        this.mechids.put(999,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100, EMechclass.ASSAULT,"FOUNDER","ATLAS AS7-D(F)","AS7-D(F)"));
