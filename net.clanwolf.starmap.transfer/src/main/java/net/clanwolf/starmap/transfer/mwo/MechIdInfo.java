...
public class MechIdInfo {
    ...
    private void InitializeMechIds(){
        ...
        this.mechids.put(86,new MechIdInfo(EFaction.INNERSPHERE,"JENNER",35,EMechclass.LIGHT, "Sarah","JENNER JR7-D(S)","JR7-D(S)"));
        ...
        this.mechids.put(125,new MechIdInfo(EFaction.INNERSPHERE,"GRIFFIN",55,EMechclass.MEDIUM, "Phoenix","GRIFFIN GRF-1N(P)","GRF-1N(P)"));
        ...
        this.mechids.put(651,new MechIdInfo(EFaction.INNERSPHERE,"HELLSPAWN",45,EMechclass.MEDIUM, "Special","HELLSPAWN HSN-9F","HSN-9F"));
        this.mechids.put(652,new MechIdInfo(EFaction.INNERSPHERE,"HELLSPAWN",45,EMechclass.MEDIUM, "Special","HELLSPAWN HSN-7P","HSN-7P"));
        this.mechids.put(653,new MechIdInfo(EFaction.INNERSPHERE,"HELLSPAWN",45,EMechclass.MEDIUM, "Special","HELLSPAWN HSN-8P","HSN-8P"));
        ...
        this.mechids.put(825,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30,EMechclass.LIGHT, "Special","SNOWBALL","UM-R60L(S)"));
        this.mechids.put(826,new MechIdInfo(EFaction.INNERSPHERE,"PHOENIXHAWK",45,EMechclass.MEDIUM, "Special","FIREBALL","PXH-1K(S)"));
        ...
        this.mechids.put(840,new MechIdInfo(EFaction.INNERSPHERE,"URBANMECH",30,EMechclass.LIGHT, "Standard","URBANMECH UM-R80(L)","UM-R80(L)"));
        this.mechids.put(841,new MechIdInfo(EFaction.CLAN,"VIPER",40,EMechclass.MEDIUM, "Standard","VIPER VPR-F","VPR-F"));
        this.mechids.put(842,new MechIdInfo(EFaction.CLAN,"VIPER",40,EMechclass.MEDIUM, "Standard","VIPER VPR-F(L)","VPR-F(L)"));
        this.mechids.put(843,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100,EMechclass.ASSAULT, "Standard","ATLAS AS7-K3","AS7-K3"));
        this.mechids.put(844,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100,EMechclass.ASSAULT, "Standard","ATLAS AS7-K3(L)","AS7-K3(L)"));
        this.mechids.put(845,new MechIdInfo(EFaction.CLAN,"NIGHTGYR",75,EMechclass.HEAVY, "Standard","NIGHT GYR NTG-D(CS)","NTG-D(CS)"));
        ...
        this.mechids.put(849,new MechIdInfo(EFaction.CLAN,"MARAUDERIIC",85,EMechclass.ASSAULT, "Special","MARAUDER IIC MAD-IIC-A","MAD-IIC-A(S)"));
        this.mechids.put(850,new MechIdInfo(EFaction.CLAN,"BLOODASP",90,EMechclass.ASSAULT, "Standard","BLOOD ASP BAS-E","BAS-E"));
        this.mechids.put(851,new MechIdInfo(EFaction.CLAN,"BLOODASP",90,EMechclass.ASSAULT, "Special","BLOOD ASP BAS-E(S)","BAS-E(S)"));
        this.mechids.put(852,new MechIdInfo(EFaction.CLAN,"SHADOWCAT",45,EMechclass.MEDIUM, "Standard","SHADOW CAT SHC-D","SHC-D"));
        this.mechids.put(853,new MechIdInfo(EFaction.CLAN,"SHADOWCAT",45,EMechclass.MEDIUM, "Special","SHADOW CAT SHC-D(S)","SHC-D(S)"));
        this.mechids.put(854,new MechIdInfo(EFaction.CLAN,"INCUBUS",30,EMechclass.LIGHT, "Champion","INCUBUS INC-5(C)","INC-5(C)"));
        this.mechids.put(855,new MechIdInfo(EFaction.CLAN,"KITFOX",30,EMechclass.LIGHT, "Champion","KIT FOX KFX-D(C)","KFX-D(C)"));
        this.mechids.put(856,new MechIdInfo(EFaction.INNERSPHERE,"FLEA",20,EMechclass.LIGHT, "Champion","FLEA FLE-17(C)","FLE-17(C)"));
        this.mechids.put(857,new MechIdInfo(EFaction.INNERSPHERE,"JAVELIN",30,EMechclass.LIGHT, "Champion","JAVELIN JVN-11A(C)","JVN-11A(C)"));
        this.mechids.put(858,new MechIdInfo(EFaction.CLAN,"HUNTSMAN",50,EMechclass.MEDIUM, "Champion","HUNTSMAN HMN-PRIME(C)","HMN-PRIME(C)"));
        this.mechids.put(859,new MechIdInfo(EFaction.CLAN,"VAPOREAGLE",55,EMechclass.MEDIUM, "Champion","VAPOR EAGLE VGL-2(C)","VGL-2(C)"));
        this.mechids.put(860,new MechIdInfo(EFaction.INNERSPHERE,"DERVISH",55,EMechclass.MEDIUM, "Champion","DERVISH DV-7D(C)","DV-7D(C)"));
        this.mechids.put(861,new MechIdInfo(EFaction.INNERSPHERE,"VULCAN",40,EMechclass.MEDIUM, "Champion","VULCAN VL-5T(C)","VL-5T(C)"));
        this.mechids.put(862,new MechIdInfo(EFaction.CLAN,"LINEBACKER",65,EMechclass.HEAVY, "Champion","LINEBACKER LBK-H(C)","LBK-H(C)"));
        this.mechids.put(863,new MechIdInfo(EFaction.CLAN,"SUMMONER",70,EMechclass.HEAVY, "Champion","SUMMONER SMN-D(C)","SMN-D(C)"));
        this.mechids.put(864,new MechIdInfo(EFaction.INNERSPHERE,"ARCHER",70,EMechclass.HEAVY, "Champion","ARCHER ARC-2R(C)","ARC-2R(C)"));
        this.mechids.put(865,new MechIdInfo(EFaction.INNERSPHERE,"MARAUDER",75,EMechclass.HEAVY, "Champion","MARAUDER MAD-9M(C)","MAD-9M(C)"));
        this.mechids.put(866,new MechIdInfo(EFaction.CLAN,"BLOODASP",90,EMechclass.ASSAULT, "Champion","BLOOD ASP BAS-A(C)","BAS-A(C)"));
        this.mechids.put(867,new MechIdInfo(EFaction.CLAN,"MARAUDERIIC",85,EMechclass.ASSAULT, "Champion","MARAUDER IIC MAD-IIC(C)","MAD-IIC(C)"));
        this.mechids.put(868,new MechIdInfo(EFaction.INNERSPHERE,"ANNIHILATOR",100,EMechclass.ASSAULT, "Champion","ANNIHILATOR ANH-1A(C)","ANH-1A(C)"));
        this.mechids.put(869,new MechIdInfo(EFaction.INNERSPHERE,"CYCLOPS",90,EMechclass.ASSAULT, "Champion","CYCLOPS CP-10-Q(C)","CP-10-Q(C)"));
        this.mechids.put(870,new MechIdInfo(EFaction.INNERSPHERE,"ATLAS",100,EMechclass.ASSAULT, "Special","ATLAS AS7-D-DC(P)","AS7-D-DC(P)"));
        this.mechids.put(871,new MechIdInfo(EFaction.INNERSPHERE,"CATAPULT",65,EMechclass.HEAVY, "Special","CATAPULT CPLT-K2(P)","CPLT-K2(P)"));
        this.mechids.put(872,new MechIdInfo(EFaction.INNERSPHERE,"HUNCHBACK",50,EMechclass.MEDIUM, "Special","HUNCHBACK HBK-4P(P)","HBK-4P(P)"));
        this.mechids.put(873,new MechIdInfo(EFaction.INNERSPHERE,"JENNER",35,EMechclass.LIGHT, "Special","JENNER JR7-F(P)","JR7-F(P)"));
        this.mechids.put(874,new MechIdInfo(EFaction.CLAN,"JENNERIIC",35,EMechclass.LIGHT, "Special","JENNER IIC JR7-IIC-A(P)","JR7-IIC-A(P)"));
